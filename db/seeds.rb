...
ApplicationRecord.transaction do
    ...
    card_1 = Card.create!({title:"return the child to its home",list_id:list_1.id,order:1})
    card_2 = Card.create!({title:"figure out why the child is so special",list_id:list_1.id,order:2})
    card_3 = Card.create!({title:"pick up diapers",description:"extra absorbent",list_id:list_1.id,order:3})
    card_4 = Card.create!({title:"discuss playground rules and force-choking",list_id:list_1.id,order:4})
    card_5 = Card.create!({title:"keep the child safe",list_id:list_2.id,order:1})
    ...
    card_9 = Card.create!({title:"rescue child from Dr. Pershing's laboratory",due_date:"2019-11-22",list_id:list_3.id,order:3})
    ...
    card_12 = Card.create!({title:"Mythrol",due_date:"2019-11-12",list_id:list_6.id,order:1})
    card_13 = Card.create!({title:"Amon Zarander",list_id:list_6.id,order:2})
    card_14 = Card.create!({title:"Karesh Carn",list_id:list_6.id,order:3})
    card_15 = Card.create!({title:"Voka Korr",list_id:list_6.id,order:4})
    card_16 = Card.create!({title: "Gaff Qorbin",list_id:list_6.id,order:5})
    card_17 = Card.create!({title:"Rebuild Nevarro",list_id:list_7.id,order:1})
    card_18 = Card.create!({title:"recruit new members for Q3",list_id:list_8.id,order:1})
    card_19 = Card.create!({title:"find Mando and the Child",list_id:list_9.id,order:1})
    card_20 = Card.create!({title:"recruit new members for Q2",list_id:list_9.id,order:2})
    card_21 = Card.create!({title:"recruit new members for Q1",list_id:list_9.id,order:3})
    card_22 = Card.create!({title:"restock supplies",list_id:list_10.id,order:1})
    card_23 = Card.create!({title:"child proof",list_id:list_10.id,order:2})
